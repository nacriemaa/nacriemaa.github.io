...
<xsl:template match="/rss">
	...
	<meta name="description" content="»Wild Life« is a responsive theme for Jekyll based on the fabulous foundation framework with beautiful typography and a bright color palette.">
	...
	<meta property="og:description" content="»Wild Life« is a responsive theme for Jekyll based on the fabulous foundation framework with beautiful typography and a bright color palette.">
	...
	<meta name="twitter:description" content="»Wild Life« is a responsive theme for Jekyll based on the fabulous foundation framework with beautiful typography and a bright color palette.">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar data-options="scrolltop: false">
    <ul class="title-area">
      <li class="name">
      <h1 class="hide-for-large-up"><a href="http://localhost:4000" class="icon-tree"> Wild Life</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/about/">About Us</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000">Meet The Team</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">What Make WildLife Team Different ?</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">Terms &amp; Conditions</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">Birding Trip Reports &amp; Blogs</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/tours/">Tours</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000">Birdwatching Tours</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">Photography Tours</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/checklist/">Birding Checklist</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000">List of Birds of Vietnam</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">Target Bird List</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">Endemic birds and specialities</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/hotspots/">Birding Hotspots</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000">Northen Vietnam</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">Central Vietnam</a></li>
                    

                      

                      <li><a  href="http://localhost:4000">Southern Vietnam</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Wild Life – A Flexible Theme for Jekyll">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Wild Life – A Flexible Theme for Jekyll">
			</a>
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              »Wild Life« is a responsive theme for Jekyll based on the fabulous foundation framework with beautiful typography and a bright color palette.
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Created with &hearts; by <a href="http://phlow.de/">Nacriema</a> with <a href="http://jekyllrb.com/" target="_blank">Jekyll</a> based on <a href="http://phlow.github.io/feeling-responsive/">Feeling Responsive</a>.</p>
          </section>
